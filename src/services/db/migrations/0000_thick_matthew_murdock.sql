...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "nursery_products" ADD CONSTRAINT "nursery_products_site_id_site_info_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."site_info"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
